                ...
                <form class="form-horizontal" method="post">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="firstname" value="<?php echo $arData['firstname'] ?? ''; ?>" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Фамилия</label>
                            <div class="col-sm-10">
                                <input type="text" name="lastname" value="<?php echo $arData['lastname'] ?? ''; ?>" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
